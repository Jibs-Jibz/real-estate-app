...
const SvgBackground1 = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      ...
      height="100%"
    >
      <rect fill="#81D4D8" width="540" height="450" />
      <defs>
        <linearGradient
          id="a"
          ...
          y1="0"
          y2="100%"
          gradientTransform="rotate(329,674,524)"
        >
          <stop offset="0" stopColor="#81D4D8" />
          <stop offset="1" stopColor="#BB80AC" />
        </linearGradient>
        <pattern
